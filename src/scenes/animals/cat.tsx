...
export default function CatComponent() {
  ...
  const generatePDF = () => {
    ...
    doc.save("cat_list.pdf");
  };
  const filteredOriginal = products.filter((item) => item.type === "Cat");
      ...
      <Box sx={{ display: "flex", minHeight: "100dvh" }}>
        ...
        >
          ...
          <Breadcrumbs separator={<ChevronRightRoundedIcon />} sx={{ mb: 2 }}>
            ...
            <Typography color="primary">Cat</Typography>
          </Breadcrumbs>
          <Box
            sx={{
              display: "flex",
          ...
          >
            <Typography level="h2">Cat List</Typography>
            <Button
