...
export default function ParrotComponent() {
  ...
  const filteredOriginal = products.filter((item) => item.type === "Parrot");
  const generatePDF = () => {
    const doc = new jsPDF();
    doc.text("Parrot List", 14, 10);
      ...
      <Box sx={{ display: "flex", minHeight: "100dvh" }}>
        ...
        >
          ...
          <Breadcrumbs separator={<ChevronRightRoundedIcon />} sx={{ mb: 2 }}>
            ...
            <Typography color="primary">Parrot</Typography>
          </Breadcrumbs>
          <Box
            sx={{
              display: "flex",
          ...
          >
            <Typography level="h2">Parrot List</Typography>
            <Button
