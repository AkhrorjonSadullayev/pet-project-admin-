...
export default function FishComponent() {
  ...
  const filteredOriginal = products.filter((item) => item.type === "Fish");
  const generatePDF = () => {
    const doc = new jsPDF();
    doc.text("Fish List", 14, 10);
      ...
      <Box sx={{ display: "flex", minHeight: "100dvh" }}>
        ...
        >
          ...
          <Breadcrumbs separator={<ChevronRightRoundedIcon />} sx={{ mb: 2 }}>
            ...
            <Typography color="primary">Fish</Typography>
          </Breadcrumbs>
          <Box
            sx={{
              display: "flex",
          ...
          >
            <Typography level="h2">Fish List</Typography>
            <Button
