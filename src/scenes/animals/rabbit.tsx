...
export default function RabbitComponent() {
  ...
  const filteredOriginal = products.filter((item) => item.type === "Rabbit");
  const generatePDF = () => {
    const doc = new jsPDF();
    doc.text("Rabbit List", 14, 10);
      ...
      <Box sx={{ display: "flex", minHeight: "100dvh" }}>
        ...
        >
          ...
          <Breadcrumbs separator={<ChevronRightRoundedIcon />} sx={{ mb: 2 }}>
            ...
            <Typography color="primary">Rabbit</Typography>
          </Breadcrumbs>
          <Box
            sx={{
              display: "flex",
          ...
          >
            <Typography level="h2">Rabbit List</Typography>
            <Button
